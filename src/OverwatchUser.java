...
//GENERAL
    ...
    private String objectiveKills_Total;
    private String finalBlows_Total;
    private String enviromentalKills_Total;
		...
		System.out.println("Url: " + driver.getCurrentUrl());
	        ...
	        if(competitive)
	        {
	        	...
	        	//WebElement userName = driver.findElement(By.cssSelector(".player-info > .name"));
	 	        ...
	 	        this.healing_Total = containerGames.get(27).findElement(By.cssSelector(".value")).getText();
	...
	public void searchQuickPlayStatsNormal(WebDriver driver, long startTime) {
		WebElement userName = driver.findElement(By.cssSelector(".player-info > .name"));
	        ...
	        //ASSIST 
	        List<WebElement> containerAssist = driver.findElements(By.cssSelector(".aside > .material-card > .stats-large > .stat"));
	        this.healing_Total = containerGames.get(22).findElement(By.cssSelector(".value")).getText();
	        System.out.println("Total healing: " + healing_Total);
...
//	 	        System.out.println("AMount Medals: " + bronzeMedal);
     ...
     */
	public String getEliminations_KD() {
     ...
     */
	public String getEliminations_kad() {
	...
	public String getDamage_Average() {
		return damage_Average;
	}

	public String getHealing_Average() {
		return healing_Average;
	}


	public String getEliminations_Total() {
		try {
			
			if(eliminations_Total.equals(null) || eliminations_Total == null || eliminations_Total.length() < 1)
				return "0";
			else
	...
	public String getEnviromentalKills_Total() {
	...
	public String getHealing_Total() {
		return healing_Total;
	}

	public String getEliminations_Most() {
		return eliminations_Most;
	}

	public String getFinalBlows_Most() {
		return finalBlows_Most;
	}

	public String getDamage_Most() {
		return damage_Most;
	}

	public String getHealing_Most() {
		return healing_Most;
	}

	public String getObjectiveKills_Most() {
		return objectiveKills_Most;
	}

	public String getObjectiveTime_Most() {
		return objectiveTime_Most;
	}

	public String getSoloKills_Most() {
		return soloKills_Most;
	}

	public String getTimeOnFire_Most() {
	...
	public String getEnviromentalDeaths_Total() {
		return null;
	}
	...
	public String getMultiKills_Total() {
		return multiKills_Total;
	}



	public String getDeaths_Total() {
		return deaths_Total;
	}



	public String getDeaths_Average() {
